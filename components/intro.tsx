...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">M Izzuddin Fadlurrahman Ar Rabbani.</span>
      </motion.h1>
      <motion.h4
        ...
        animate={{ opacity: 1, y: 0 }}
      >
          <span className='font-bold'>3 years</span> of experience in <span className='font-bold'>fullstack development</span>, using <span  className='font-bold'>Laravel</span> for developing a <span className='italic'>website and web applications</span>.
      </motion.h4>
      <motion.div
      ...
      >
        <a
          ...
          href="https://www.linkedin.com/in/mizzuddinfar-rabbani/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="mailto:fafa.rabbanii@gmail.com"
          target="_blank"
        >
          <RiMailSendLine />
        </a>
        ...
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.instagram.com/fafarabbani/"
          target="_blank"
        >
          <BsInstagram />
        </a>
