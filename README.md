...
```bash
  git clone https://github.com/fafarabbani/my-portofolio-next.git
```
...
Visit the live portfolio website at https://fafarabbani.my.id/](https://fafarabbani.my.id/).
...
Thank you for visiting my portfolio repository! Feel free to reach out to me via [email](mailto:fafa.rabbanii@gmail.com) if you have any questions or wish to collaborate.
